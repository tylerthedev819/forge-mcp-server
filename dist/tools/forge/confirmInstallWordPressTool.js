...
const paramsSchema = {
    ...
    siteId: z
        .string()
        .optional()
        .describe('The ID of an existing site to delete and recreate with WordPress. If provided along with createFreshSite=true, the site will be deleted first. If createFreshSite=false, WordPress will be installed on this existing site (may fail if site already has an app).'),
    siteName: z
        .string()
        .describe('The domain name for the WordPress site (e.g., "example.com"). This will be used as the site name.'),
    database: z
        .string()
