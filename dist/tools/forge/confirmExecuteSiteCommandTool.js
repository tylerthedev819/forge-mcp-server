...
const paramsSchema = {
    ...
    command: z
        .string()
        .describe('The shell command to execute on the site. This will run in the context of the site directory. WARNING: Shell commands can be destructive - use with caution.'),
};
const paramsZodObject = z.object(paramsSchema);
export const confirmExecuteSiteCommandTool = {
...
WARNING: Shell commands have full access to the site's filesystem and can be destructive. Always review commands carefully before confirming.`,
    ...
    handler: async (params) => {
        ...
        const confirmation = createConfirmation(executeSiteCommandConfirmationStore, { serverId, siteId, command });
        return toMCPToolResult({
            ...
            summary: {
                ...
                siteId,
                command,
                warning: 'This will execute a shell command on the server. Shell commands have full access to the site filesystem and can be destructive. Please review the command carefully.',
            },
            instructions: 'Please confirm you want to execute this command by calling execute_site_command with this confirmationId.',
        });
    },
};
