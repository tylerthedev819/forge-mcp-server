...
const paramsSchema = {
    ...
    createFreshSite: z
        ...
        .optional()
        .default(true)
        .describe('Whether to delete any existing site and create a fresh one before installing WordPress. Defaults to true.'),
    isolated: z
        .boolean()
        .optional()
    ...
    confirmationId: z
        .string()
        .describe('This confirmationId must be obtained from confirm_install_wordpress tool after explicit user confirmation.'),
};
const paramsZodObject = z.object(paramsSchema);
// Helper to wait for site to be ready
async function waitForSiteReady(serverId, siteId, forgeApiKey, maxAttempts = 30, delayMs = 2000) {
    ...
    handler: async (params, forgeApiKey) => {
        try {
            ...
            if (createFreshSite !== false) {
                ...
                const createResponse = await callForgeApi({
