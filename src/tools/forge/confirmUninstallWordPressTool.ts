...
export const uninstallWordPressConfirmationStore =
...
export const confirmUninstallWordPressTool: ForgeToolDefinition<typeof paramsSchema> = {
  ...
  handler: async params => {
    ...
    const summary =
      `⚠️ WARNING: You are about to uninstall WordPress!\n\n` +
